package com.alloc64.heating.prefs;
...
public class JsonSharedPreferences {
    ...
    public JsonSharedPreferences(@Value("${heating.sharedprefsfile:shared-prefs.json}") String filePath) {
    ...
    public Double getDouble(String key, Double defaultValue) {
        return data.containsKey(key) ? (Double) data.get(key) : defaultValue;
    }
